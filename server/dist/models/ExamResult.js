...
exports.validateTopicScore = exports.validateExamResult = exports.ExamResultModel = void 0;
class ExamResultModel {
    ...
    getWeakTopics(threshold = 70) {
        return this.topicBreakdown
            .filter(topic => topic.percentage < threshold)
            .map(topic => topic.topic);
    }
    getStrongTopics(threshold = 80) {
        return this.topicBreakdown
            .filter(topic => topic.percentage >= threshold)
            .map(topic => topic.topic);
    }
...
exports.ExamResultModel = ExamResultModel;
const validateExamResult = (examData) => {
    const errors = [];
...
exports.validateExamResult = validateExamResult;
const validateTopicScore = (topicScore) => {
    const errors = [];
    const validTopics = [
        'Databricks Lakehouse Platform',
        'ELT with Spark SQL and Python',
...
exports.validateTopicScore = validateTopicScore;
