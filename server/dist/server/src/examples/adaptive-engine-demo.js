...
exports.demonstrateAdaptiveEngine = demonstrateAdaptiveEngine;
const services_1 = require("../services");
// Mock exam results for demonstration
function createExamResult(topicScores, examDate) {
    const allTopics = [
    ...
    const topicBreakdown = allTopics.map(topic => {
...
async function demonstrateAdaptiveEngine() {
    ...
    const adaptiveService = new services_1.AdaptiveQuestionService();
    const examService = new services_1.ExamGenerationService();
...
//# sourceMappingURL=adaptive-engine-demo.js.map